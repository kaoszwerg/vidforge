...
export const de = {
  ...
  "integrity.bulkCheck": "Ausgewählte prüfen",
  "integrity.bulkProgress": "Prüfe {done}/{total}…",
  "integrity.bulkDefective": "{count} von {total} defekt",
  "integrity.bulkAllHealthy": "Alle {total} intakt",
  "integrity.repairDefective": "Defekte reparieren ({count})",
...
export const en: Record<MessageKey, string> = {
  ...
  "integrity.bulkCheck": "Check selected",
  "integrity.bulkProgress": "Checking {done}/{total}…",
  "integrity.bulkDefective": "{count} of {total} defective",
  "integrity.bulkAllHealthy": "All {total} healthy",
  "integrity.repairDefective": "Repair defective ({count})",
